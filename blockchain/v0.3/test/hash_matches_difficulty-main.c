...
/**
 * _print_hex_buffer - entry to function
 * Desc: _print_hex_buffer function that prints
 *  a buffer in its hexadecimal form
...
/**
 * test_hash_matches_difficulty - entry to function
 * Desc: test_hash_matches_difficulty function to test
 * the hash_matches_difficulty function
 * @hash:       Tested hash
